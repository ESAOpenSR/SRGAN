...
1. Update the docs and potentially README.md with details of changes to the interface, this includes new environment 
   variables, useful file locations and container parameters.
2. Increase the version numbers in any examples files and the README.md and documentation to the new version that this
   Pull Request would represent.
3. You may merge the Pull Request in once you have the sign-off of the repository owner, or if you 
...
reported by contacting the project team at info@opensr.eu. All
